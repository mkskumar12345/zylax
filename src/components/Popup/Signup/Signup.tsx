...
const Signup: React.FC<PopupProps> = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50 ">
      <div className="bg-white p-4 rounded shadow-md relative w-[850px] h-[600px]">
        <button
          onClick={onClose}
          ...
          <div className="flex flex-col justify-center gap-3 w-[450px] p-5">
            ...
            <div className="flex justify-between">
              <div className="text-left">
                ...
                <br />
                <input className="border-[#CCCCCC] border w-[200px] h-[23px] rounded-lg" />
              </div>
              <div className="text-left">
            ...
            <div className="text-left w-full">
              ...
              <span className="text-[rgb(255,134,130)]">Login</span>
            </div>
            ...
            <div className="flex justify-between w-full">
              <div className="border-[#3869EB] border rounded-lg w-[120px] h-[22px] flex justify-center items-center">
